...
import { MoveHorizontal as MoreHorizontal, EyeOff, Zap, Flame, Clock, FileText, ChevronRight, ChevronDown } from 'lucide-react';
    ...
    <>
      <div
        ...
        <div className={`flex items-center flex-1 transition-opacity ${!product.visible ? 'opacity-50' : ''}`}>
          <div className="min-w-[13rem] flex-1 px-1.5 py-1 border-r border-slate-100">
        ...
        <div className="w-14 flex-shrink-0 px-1.5 py-1 flex items-center justify-center relative">
          <button
